...
messages = {
    ...
    103 : {
        "error": {"status_code": 103, "msg": "Student with given id doesn't exist!"},
        "status": status.HTTP_422_UNPROCESSABLE_ENTITY   
    },
    104 : { 
    ...
    107 : { 
        "error": {"status_code": 107, "msg": "Permission Denied"},
        "status": status.HTTP_422_UNPROCESSABLE_ENTITY   
    },
    108 : { 
        "error": {"status_code": 108, "msg": "Invalid department_id."},
        "status": status.HTTP_422_UNPROCESSABLE_ENTITY   
    }
}